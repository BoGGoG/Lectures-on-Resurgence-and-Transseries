...
\date{Week 12, Version: \today}

\begin{document}
\maketitle

\begin{questions}
    \question (\textbf{The Airy Equation: Borel Summation})\\
    We have that
        \begin{equation}
        ...
        \end{equation}
        \begin{parts}
            \part (\textbf{Asymptotic behavior of $a_n$})\\
            \label{part:asymptan}%
            Calculate the asymptotic behavior of $a_n$ as $n\to \infty$ using Stirling's formula.
            Determine the instanton action $A$ from it.
            Where will the pole of the Borel transform be? You can read it off from the large order behavior of $a_n$.
            \part (\textbf{Borel Transform})\\
            Let's focus on the sum that is multiplying the exponential.
            With the transformation $x=z^{\frac{2}{3}}$ we write it as
            \begin{equation}
                \phi_{\Ai}(z) = \sum_{n=0}^\infty \frac{a_n}{z^n}\,.
            \end{equation}
            Show that the Borel transform
            \begin{equation}
                \hat{\phi}(\zeta) = \sum_{n=0}^\infty \frac{a_n}{n!}\zeta^n\,,
            \end{equation}
            can be analytically continued to
            \begin{equation}
            \hat{\phi}_{\Ai} = - \frac{5}{48} ~_2F_1\left(\frac{7}{6}, \frac{11}{6}; 2; -\frac{3}{4}\zeta\right)\,.
            \end{equation}

...
\begin{questions}
    ...
    Hankel came up with an asymptotic expansion for the \emph{modified Hankel function}\footnote{also called \emph{Basset function, modified Bessel function of the second kind and Macdonald function}}
        $K_\alpha(z)$,
        \begin{equation}
        ...
        figure out for what $\zeta$ $\calB[\tilde{Z}_\text{asympt.}](\zeta)$ converges.

...
\begin{questions}
    ...
    \begin{parts}
        ...
        \begin{equation}
            ...
            \partial_a^{2k} \sqrt{\frac{\pi}{a}} \bigg|_{a\to 1}\,.
        ...
        Note: I think it's actually $(k-1)!$, but that still scales like $k!$.
        ...
        For $\sum_{n=0}^\infty a_n \lambda^n$, $a_n \sim A^{-n} n!$ the optimal truncation is around\footnote{take some closest integer, I don't think it matters if you round up or down, since it's only an estimate anyways.}
        \begin{equation}
